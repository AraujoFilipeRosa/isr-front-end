...
<template>
  <div id="valores" class="container-sm-fluid container-md-fluid container-lg mb-lg-4 mb-4 page-container">
    <!-- Header dos Valores -->
    ...
    <section v-motion :initial="{ opacity: 0, y: 0 }" :visible="{ opacity: 1, y: 0 }" :duration="1000" :delay="200"
      ...
      <div class="col-lg-4 col-md-6 mb-4">
        <ComponenteCard variante="valor">
          ...
          <h3 class="card-title h5 font-weight-bold mb-3">
            {{ t('valores.lista.empatia.titulo') }}
          </h3>
      ...
      <div class="col-lg-4 col-md-6 mb-4">
        <ComponenteCard variante="valor">
          ...
          <h3 class="card-title h5 font-weight-bold mb-3">
            {{ t('valores.lista.sustentabilidade.titulo') }}
          </h3>
          <p class="card-text text-muted flex-grow-1">
      ...
      <div class="col-lg-4 col-md-6 mb-4">
        <ComponenteCard variante="valor">
          ...
          <h3 class="card-title h5 font-weight-bold mb-3">
            {{ t('valores.lista.equidade.titulo') }}
          </h3>
          <p class="card-text text-muted flex-grow-1">
